            ...
            this.addSlot(new SlotItemHandler(addItemStackHandler, i, 18 + i * 18, 116) {
...

                {
                    if (this.getSlotIndex() == 0)
                        this.set(bot.getEnergyAdd());
                    else if (this.getSlotIndex() == 1)
                        this.set(bot.getMCAttributeAdd());
                    else
                        this.set(bot.getCorrespondingAbilityAdd());
                }
                ...
                public void set(@NotNull ItemStack stack) {
                    super.set(stack);
                    if (this.getSlotIndex() == 0)
                        bot.setEnergyAdd(stack);
                    else if (this.getSlotIndex() == 1)
                        bot.setMcAttributeAdd(stack);
                    else
                        bot.setCorrespondingAbilityAdd(stack);
                }
            });
        }
