...
public class CivilizationCookingSyntheticFormulas {
    ...
    /*九转大肠*/
    public static final CookingRecipe BRAISED_INTESTINES_BROWN_SAUCE = new CookingRecipe(CookingDishesType.Plate, "braised_intestines_brown_Sauce",CookingTool.IronPot).setNeedCondimentItems("oil","salt","vinegar").setNeedCookingItems("carob","cinnamon","minecraft:porkchop");
    /*扬州炒饭*/
    ...
    /*番茄炒鸡蛋*/
    public static final CookingRecipe SCRAMBLED_TOMATO_EGG = new CookingRecipe(CookingDishesType.Plate, "scrambled_tomato_egg",CookingTool.IronPot).setNeedCondimentItems("oil","salt","sauce","vinegar").setNeedCookingItems();
    /*白米饭*/
    public static final CookingRecipe RICE = new CookingRecipe(CookingDishesType.Plate, "rice",CookingTool.FoodSteamer).setNeedCookingItems();
    /*杂粮饭*/
    public static final CookingRecipe COARSE_GRAIN_RICE = new CookingRecipe(CookingDishesType.Plate, "coarse_grain_rice",CookingTool.FoodSteamer).setNeedCookingItems();
    /*芹菜炒肉*/
    public static final CookingRecipe CELERY_FRIED_MEAT = new CookingRecipe(CookingDishesType.Plate, "celery_fried_meat",CookingTool.IronPot).setNeedCondimentItems("oil","salt","sauce").setNeedCookingItems();
    /*酸辣黄瓜*/
    public static final CookingRecipe HOT_SOUR_CUCUMBER = new CookingRecipe(CookingDishesType.Plate, "hot_sour_cucumber",CookingTool.IronPot).setNeedCondimentItems("vinegar","salt").setNeedCookingItems();
    /*玉米冬瓜汤*/
    public static final CookingRecipe CORN_GOURD_SOUP = new CookingRecipe(CookingDishesType.Bowl, "corn_gourd_soup",CookingTool.Casserole).setNeedCondimentItems("salt").setNeedCookingItems();
    /*丝瓜炒蛋*/
    public static final CookingRecipe TOWEL_GOURD_EGG = new CookingRecipe(CookingDishesType.Plate, " towel_gourd_egg",CookingTool.IronPot).setNeedCondimentItems("oil","salt","sauce").setNeedCookingItems();
    /*卤鸡蛋*/
    public static final CookingRecipe HALOGEN_EGG = new CookingRecipe(CookingDishesType.Plate, "halogen_egg",CookingTool.Casserole).setNeedCookingItems();
    /*卤肉*/
    public static final CookingRecipe POT_STEWED_MEAT = new CookingRecipe(CookingDishesType.Plate, "pot_stewed_meat",CookingTool.Casserole).setNeedCookingItems();
