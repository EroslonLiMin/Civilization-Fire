package com.daylight.civilization_fire.common.content.item.material;
...
public enum VegetableMaterials implements ArmorMaterial {
    ...
    VegetableMaterials(String pName, int pDurabilityMultiplier, int[] pSlotProtections, int pEnchantmentValue, SoundEvent pSound, float pToughness, float pKnockbackResistance, Supplier<Ingredient> pRepairIngredient) {
        this.name = pName;
