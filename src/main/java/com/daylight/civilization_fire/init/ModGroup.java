...
public class ModGroup {
    public static final ModCreativeModeTab AGRICULTURE_CREATIVE_MODE_TAB = new ModCreativeModeTab("agriculture_creative_mode_tab", () -> new ItemStack(ItemRegistry.CLAY_BLOCK_BLOCK.get()));//农业部门
