...
public class ModGroup {
    public static final ModCreativeModeTab AGRICULTURE_CREATIVE_MODE_TAB = new ModCreativeModeTab("agriculture_creative_mode_tab", () -> new ItemStack(ItemRegistry.WOOD_HANDLE_PLOUGH.get()));//农业部门
    ...
    public static final ModCreativeModeTab COOKING_CREATIVE_MODE_TAB = new ModCreativeModeTab("cooking_creative_mode_tab", () -> new ItemStack(BlockRegistry.COOKING_BENCH_BLOCK.get()));//烹饪
