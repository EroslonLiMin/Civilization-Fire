...
public class IronPloughModel extends EntityModel<PloughEntity.IronPloughEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			CivilizationFire.resource("ironplough"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bb_main = partdefinition.addOrReplaceChild("bb_main",
				CubeListBuilder.create().texOffs(10, 0)
						.addBox(-0.5F, -7.0F, -11.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F))
						...
						.texOffs(0, 16).addBox(-2.0F, -8.0F, -15.0F, 4.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));

		bb_main.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(10, 1).addBox(-0.5F, 0.0F, -0.5F, 1.0F, 5.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -14.0F, 19.5F, 0.7854F, 0.0F, 0.0F));

		bb_main.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(10, 0).addBox(-0.5F, -3.0F, -0.5F, 1.0F, 6.0F, 1.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -5.4142F, 4.5F, 0.48F, 0.0F, 0.0F));

		bb_main.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(14, 0).addBox(-1.0F, -13.0F, -1.0F, 2.0F, 24.0F, 2.0F,
						new CubeDeformation(-0.1F)),
				PartPose.offsetAndRotation(0.0F, -8.0F, 12.0F, -0.7854F, 0.0F, 0.0F));

		bb_main.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(14, 0).addBox(-1.0F, -12.0F, -9.0F, 2.0F,
				24.0F, 2.0F, new CubeDeformation(0.0F)),
	...
	@Override
	public void setupAnim(PloughEntity.IronPloughEntity entity, float limbSwing, float limbSwingAmount,
