...
public class IronPotScreen extends BaseContainerScreen<IronPotMenu> {
    public final IronPotBlock.IronPotBlockEntity ironPotBlockEntity;
    public IronPotScreen(IronPotMenu pMenu, Inventory pPlayerInventory, Component pTitle) {
        super(pMenu, pPlayerInventory, pTitle, CivilizationFire.resource("textures/screen/iron_pot_screen.png"));
        this.imageWidth = 216;
        this.imageHeight = 216;
        this.ironPotBlockEntity = pMenu.blockEntity;
    }
    ...
    protected void renderBg(PoseStack matrixStack, float partialTicks, int mouseX, int mouseY) {
        ...
        blit(matrixStack, leftPos + 46, topPos + 116, 0,0, (int) (124 * (ironPotBlockEntity.cookingFire / 1000.0)), 8 ,124, 8);
    }
}